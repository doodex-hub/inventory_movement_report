...
**Sumber:** diturunkan dari skenario S-01..S-06 di `../10_BUSINESS_FLOW_MIGRATION.md`, dikelompokkan per `Level`.
...
| `03_DETAIL.md` | S-04, S-05 — multi-company & bug dipertahankan | QA menyeluruh sebelum rilis |

...
|---|---|---|---|---|
| 2026-08-26 | Odoo 19.0, docker (odoo:19.0 resmi) | AI (automated test, bukan klik manual) | Pass | Dikonfirmasi `test_ac_05_02_create_on_view_fails`, 0 failed 0 error dari 9 test |

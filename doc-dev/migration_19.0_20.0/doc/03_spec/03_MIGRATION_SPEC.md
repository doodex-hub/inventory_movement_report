...
| `LICENSE`, `README.md`, `LISEZMOI.md`, `googleaeed8a7b9ec156e7.html` (file verifikasi Google Search Console) di dalam `product_history_report/` | — | **Tidak diubah** (non-kode; README/LISEZMOI "17.0" basi → MF-08). *(Baris ditambahkan saat Step 4 — gap cakupan.)* | Rendah | — |
